...
const char*                kMsgDTransferManifest = "DTRM%8i%s";
const char*                kMsgDTransferAccept   = "DTRA%8i%1i";
const char*                kMsgDTransferChunk    = "DTRC%8i%4i%8i%s";
const char*                kMsgDTransferResume   = "DTRK%8i%4i%8i";
const char*                kMsgDTransferFinished = "DTRF%8i%1i";
const char*                kMsgDTransferCancel   = "DTRX%8i";
